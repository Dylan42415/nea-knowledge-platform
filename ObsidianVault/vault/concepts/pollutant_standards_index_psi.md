...
## Summary
The Pollutant Standards Index (PSI) is an index used in Singapore to provide easily understandable information about daily air quality levels, computed from 24-hour concentrations of six criteria pollutants.

## Key Data / Findings

| 24-hour PSI Descriptor | Range | Healthy Persons | Elderly, Pregnant Women, Children | Persons with Chronic Lung Disease, Heart Disease |
|---|---|---|---|---|
...
- **COMPUTED_FROM** → [[Carbon Monoxide (CO)]]
- **COMPUTED_FROM** → [[Ground-Level Ozone]]
