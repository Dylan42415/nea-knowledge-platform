...
## Summary
A variety of volatile organic compounds (VOCs) are tracked alongside criteria air pollutants via continuous air monitoring sensors in Singapore.

## Key Data / Findings

| Parameter | Value | Benchmark |
|---|---|---|
| Category | Volatile Organic Compounds (VOCs) | National Environment Agency Standards |
